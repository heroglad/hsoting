                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold">We <span className='font-black'>Engineer Solutions</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                With years of experience in software analysis, architecture, and design, we don’t just build systems—we engineer scalable, future-proof solutions. Leveraging the latest in technology trends and digital innovation, we craft custom strategies that streamline your operations, minimize costs, and drive long-term growth.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold">We <span className='font-black'>Co-Create With You</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>Think of us as an extension of your team. Whether it’s scaling your current application or building something entirely new, we work side-by-side with your internal developers and stakeholders to design tailor-made solutions. Our collaborative approach ensures that what we build fits your workflows perfectly—efficient, intuitive, and built for impact.</p>
                            </div>
                        </div>
                    </div>
                </div>
